...
This project is indexed by GitNexus as **tail-claude-gui** (1593 symbols, 3811 relationships, 132 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
